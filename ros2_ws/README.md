...
## Change the rate of telemetry:
The below command configures the data enable/frequency:
`ros2 service call /tb_01/set_streams tb_msgs/srv/SetStreams "{motors: true, imu: true, ir: false, lidar: false, motors_hz: 1.0, imu_hz: 10.0, ir_hz: 0.0, lidar_hz: 0.0}"`
